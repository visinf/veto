...
class ResNet(nn.Module):
    def __init__(self, cfg, depth_backbone=False):
        ...
        stem_module_depth = _STEM_MODULES["StemWithFixedBatchNorm_1channelinput"]
        if depth_backbone:
            stage_specs = _STAGE_SPECS[cfg.MODEL.DEPTH_BACKBONE.CONV_BODY]
        else:
        ...
        if depth_backbone:
            self.stem = stem_module_depth(cfg)
        else:
...
class StemWithFixedBatchNorm_1channelinput(BaseStem):
    def __init__(self, cfg):
        super(StemWithFixedBatchNorm_1channelinput, self).__init__(
            cfg, norm_func=FrozenBatchNorm2d
        )
...
_STEM_MODULES = Registry({
    ...
    "StemWithFixedBatchNorm_1channelinput": StemWithFixedBatchNorm_1channelinput,
})
