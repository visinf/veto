...
class CombinedROIHeads(torch.nn.ModuleDict):
    ...
    def forward(self, features, proposals, targets=None, depth_features=None, logger=None):
        losses = {}
        ...
        if self.cfg.MODEL.RELATION_ON:
            ...
            # During training, self.box() will return the unaltered proposals as "detections"
            # this makes the API consistent during training and testing
            x, detections, loss_relation = self.relation(features, detections, targets=targets, depth_features=depth_features, logger=logger, x=x)
