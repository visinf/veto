...
class DatasetCatalog(object):
    DATA_DIR = "/data/gsudhakaran/dataset/scene_graph" #"/path/user/data"
    #DATA_DIR = "/data/user/dataset/scene_graph"
    DATASETS = {
        "coco_2017_train": {
        ...
        "VG_stanford_filtered_with_attribute": {
            ...
            "roidb_file": "vg/VG_100K/stanford_filtered/stanford_vg/VG-SGG-with-attri.h5",
            "dict_file": "vg/VG_100K/stanford_filtered/stanford_vg/VG-SGG-dicts-with-attri.json",
            "image_file": "vg/VG_100K/stanford_filtered/stanford_vg/image_data.json",
        },

        "VG_stanford_filtered_with_attribute_incl_depth": {
            "img_dir": "/data/gsudhakaran/dataset/scene_graph/images/VG/images",
            ...
            "roidb_file": "/data/gsudhakaran/dataset/scene_graph/annotation/VG200/with_attr/VG-SGG-with-attri.h5",
            "dict_file": "/data/gsudhakaran/dataset/scene_graph/annotation/VG200/with_attr/VG-SGG-dicts-with-attri.json",
            "image_file": "/data/gsudhakaran/dataset/scene_graph/annotation/VG200/with_attr/image_data.json",
        },


        "openimage_v4": {
            "img_dir": "open_images/open-imagev4/images",
            "ann_file": "open_images/open-imagev4/annotations/vrd-%s-anno.json",
            "cate_info_file": "open_images/open-imagev4/annotations/categories_dict.json",
        },
        ...
        "GQA_200_incl_depth": {
            "img_dir": "GQA/images",
            "depth_img_dir": "/path/user/data/GQA/depth",
