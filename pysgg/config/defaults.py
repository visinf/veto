...
_C.INPUT.MIN_SIZE_TRAIN = 800   #(800,)  # (800,)
...
_C.DATASETS.USE_BIAS = False
_C.DATASETS.REORDER_FREQ_BASED = False
...
_C.MODEL.DEPTH_BACKBONE = CN()
# The backbone conv body to use
# The string must match a function that is imported in modeling.model_builder
# (e.g., 'FPN.add_fpn_ResNet101_conv5_body' to specify a ResNet-101-FPN
# backbone)
_C.MODEL.BACKBONE.CONV_BODY = "R-50-C4"
_C.MODEL.DEPTH_BACKBONE.CONV_BODY = "R-18-C4"
...
_C.MODEL.RPN.ANCHOR_SCALES = (2.22152954, 4.12315647, 7.21692515, 12.60263013, 22.7102731)
...
_C.MODEL.ROI_RELATION_HEAD.FEATURE_EXTRACTOR_MINI = None
_C.MODEL.ROI_RELATION_HEAD.POOLER_RESOLUTION = 7
...
_C.MODEL.ROI_RELATION_HEAD.VETOTRANSFORMER = CN()
# for CreamTransformerPredictor only
_C.MODEL.ROI_RELATION_HEAD.VETOTRANSFORMER.PATCH_SIZE = int(2)
_C.MODEL.ROI_RELATION_HEAD.VETOTRANSFORMER.T_INPUT_DIM = 576
_C.MODEL.ROI_RELATION_HEAD.VETOTRANSFORMER.ENC_LAYERS = 6
_C.MODEL.ROI_RELATION_HEAD.VETOTRANSFORMER.NHEADS = 6
_C.MODEL.ROI_RELATION_HEAD.VETOTRANSFORMER.EMB_DROPOUT = 0.35
_C.MODEL.ROI_RELATION_HEAD.VETOTRANSFORMER.T_DROPOUT = 0.35

_C.GLOBAL_SETTING = CN()
_C.GLOBAL_SETTING.DATASET_CHOICE = 'VG'
_C.GLOBAL_SETTING.USE_BIAS = True
_C.GLOBAL_SETTING.BETA_LOSS = False
_C.GLOBAL_SETTING.CHOOSE_BEST_MODEL_BY_METRIC = '_mean_recall'
_C.GLOBAL_SETTING.PRINT_INTERVAL = 100

_C.MODEL.BALANCED_NORM = False
...
_C.GCL_SETTING = CN()
_C.GCL_SETTING.GROUP_SPLIT_MODE = 'divide4'
_C.GCL_SETTING.KNOWLEDGE_LOSS_COEFFICIENT = 1.0
_C.GCL_SETTING.KNOWLEDGE_TRANSFER_MODE = 'KL_logit_TopDown'
_C.GCL_SETTING.NO_RELATION_RESTRAIN = True
_C.GCL_SETTING.ZERO_LABEL_PADDING_MODE = 'rand_insert'
_C.GCL_SETTING.NO_RELATION_PENALTY = 0.1

_C.ENSEMBLE_LEARNING = CN()
_C.ENSEMBLE_LEARNING.ENABLED = False
_C.ENSEMBLE_LEARNING.TYPE = ['group']
_C.ENSEMBLE_LEARNING.VOTING = 'C'  #'C' or 'U'
_C.ENSEMBLE_LEARNING.EXPERT_GROUP = True